...
\usepackage{natbib}
\usepackage[top=0.82in,bottom=0.82in,left=0.65in,right=0.65in,columnsep=0.22in]{geometry}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{workload_simulation.png}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{roc_curves.png}
