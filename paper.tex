...
\begin{figure*}[htbp]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]{samples_hyperkvasir.png}
    \caption{HyperKvasir (training dataset)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]{"samples_kvasir-v2.png"}
...
\begin{figure*}[htbp]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{"dist_hyperkvasir_—_class_distribution.png"}
    \caption{HyperKvasir class distribution}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{"dist_kvasir-v2_—_class_distribution.png"}
...
ESGE guideline tables by co-author Mehjabin Ferdous (MPH, St.\ Francis College), who
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{imbalance_handling.png}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{training_curves.png}
...
\begin{figure*}[htbp]
  ...
  \begin{subfigure}[b]{0.92\textwidth}
    \includegraphics[width=\linewidth,height=4.8cm,keepaspectratio]{gradcam_densenet121.png}
    \caption{DenseNet-121}
  \end{subfigure}
  \vspace{1pt}
  \begin{subfigure}[b]{0.92\textwidth}
    \includegraphics[width=\linewidth,height=4.8cm,keepaspectratio]{gradcam_efficientnet_b0.png}
    \caption{EfficientNet-B0}
  \end{subfigure}
  \vspace{1pt}
  \begin{subfigure}[b]{0.92\textwidth}
    \includegraphics[width=\linewidth,height=4.8cm,keepaspectratio]{gradcam_deit_tiny.png}
    \caption{DeiT-Tiny}
  \end{subfigure}
...
\begin{figure*}[htbp]
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    \includegraphics[width=\linewidth,height=4.2cm,keepaspectratio]{confusion_matrix_densenet121.png}
    \caption{DenseNet-121}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.32\textwidth}
    \includegraphics[width=\linewidth,height=4.2cm,keepaspectratio]{confusion_matrix_efficientnet_b0.png}
    \caption{EfficientNet-B0}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.32\textwidth}
    \includegraphics[width=\linewidth,height=4.2cm,keepaspectratio]{confusion_matrix_deit_tiny.png}
    \caption{DeiT-Tiny}
  \end{subfigure}
