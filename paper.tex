...
recall at 10-epoch training depth. Note that the ablation uses 10-epoch runs to control training cost;
the main experiment trains to 25 epochs with best-checkpoint selection,
so the ablation F1 values are not directly comparable to
